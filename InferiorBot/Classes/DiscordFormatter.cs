...
namespace InferiorBot.Classes
{
    public static partial class DiscordFormatter
    {
        ...
        public static string Mention(SocketUser user, bool nickname = false)
            => nickname
        ...
        /// <returns>Formatted mention.</returns>
        public static string Mention(SocketChannel channel)
            => $"<#{channel.Id.ToString(CultureInfo.InvariantCulture)}>";

        /// <summary>
        /// Creates a mention for specified voice channel.
        /// </summary>
        /// <param name="channel">Voice channel to mention.</param>
        /// <returns>Formatted mention.</returns>
        public static string Mention(IVoiceChannel channel)
            => $"<#{channel.Id.ToString(CultureInfo.InvariantCulture)}>";
        ...
        /// <returns>Formatted mention.</returns>
        public static string Mention(SocketRole role)
        ...
        /// <returns>Formatted mention.</returns>
        public static string Mention(SocketApplicationCommand command)
        ...
        public static string Emoji(GuildEmote emoji)
